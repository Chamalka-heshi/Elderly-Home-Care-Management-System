...
// Auth context and providers for session management
...
// Layout wrapper for standalone authentication pages
...
// Wrappers for authentication routes to handle navigation logic
...
// Wrappers for profile pages to handle back-navigation based on role
...
// Root application component defining global routes and providers
const App: React.FC = () => (
  <AuthProvider>
    <BrowserRouter>
      <Routes>
