/**
 * src/features/dashboards/familymember/components/Topbar.tsx
 * Mirrors doctor Topbar exactly — role badge shows "Family Member".
 */
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Stay connected with your family member's care and wellbeing.
            </p>
          </div>
        </div>
