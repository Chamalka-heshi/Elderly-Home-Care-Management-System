/**
 * src/features/dashboards/familymember/components/Sidebar.tsx
 * Mirrors doctor Sidebar exactly — family-member MenuLabel union & subtitle copy.
 */
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Family member Panel</p>
              </div>
            </div>
            <button
