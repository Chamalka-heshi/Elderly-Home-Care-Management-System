    ...
    <>
      ...
      >
        <div className="flex h-full flex-col p-5 overflow-hidden">
          ...
          <div className="flex shrink-0 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Family Panel</p>
              </div>
            </div>
            <button
          ...
          {/* Nav — Independent Scroll Container */}
          ...
          <div className="mt-4 shrink-0 rounded-2xl border border-slate-200 bg-white/70 p-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-[11px] text-slate-500">{user?.email || 'family@carehome.lk'}</p>
              </div>
            </div>
            <div>
              <SignOutButton />
